...
\hldef{beta.prob} \hlkwb{<-} \hlkwa{function}\hldef{(}\hlkwc{x}\hldef{,} \hlkwc{alpha}\hldef{,} \hlkwc{beta}\hldef{,} \hlkwc{type}\hldef{=}\hlsng{"<="}\hldef{)\{}
  ...
  \hldef{\}}
  \hlkwa{else if} \hldef{(type} \hlopt{%in%} \hlkwd{c}\hldef{(}\hlsng{"<"}\hldef{,} \hlsng{"<="}\hldef{))\{}
    \hlkwd{return}\hldef{(}\hlkwd{pbeta}\hldef{(x, alpha, beta,} \hlkwc{lower.tail} \hldef{=} \hlnum{TRUE}\hldef{))}
  \hldef{\}}
  \hlkwa{else if} \hldef{(type} \hlopt{%in%} \hlkwd{c}\hldef{(}\hlsng{">"}\hldef{,} \hlsng{">="}\hldef{))\{}
    \hlkwd{return}\hldef{(}\hlkwd{pbeta}\hldef{(x, alpha, beta,} \hlkwc{lower.tail} \hldef{=} \hlnum{FALSE}\hldef{))}
  \hldef{\}}
\hldef{\}}
\end{alltt}
\end{kframe}
